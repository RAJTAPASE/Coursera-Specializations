...
The scripts have been solely produced, tested and executed on Windows 10 and RStudio Version 0.99.486.  
Developer: <b>Patil Akash Dnyaneshwar</b>  
GitHub Repo: [https://github.com/AkashPatil-Pixel32/Practical-Machine-Learning-by-Johns-Hopkins-University/master/Project](https://github.com/AkashPatil-Pixel32/Practical-Machine-Learning-by-Johns-Hopkins-University/master/Project)  
...
```{r warning=FALSE, error=FALSE}
setwd("~/GitHub/Practical-Machine-Learning-by-Johns-Hopkins-University/Project")
```  
